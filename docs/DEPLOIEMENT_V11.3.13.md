# SportLab V11.3.13 — Sync Tombstone Guard
...
## Déploiement
Déployer l’intégralité du projet V11.3.13 sur GitHub Pages. Aucun changement du Worker Cloud Sync ni de l’API Bridge 3.10.1 n’est requis pour cette version.

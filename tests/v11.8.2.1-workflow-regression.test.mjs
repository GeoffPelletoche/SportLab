...
test("V11.8.2.3 ships the server-snapshot Pages workflow", () => {
  assert.match(workflow, /name: Deploy SportLab Pages \+ Server Snapshot \(V11\.8\.2\.3\)/);
...
test("V11.8.2.3 exposes the snapshot build command", () => {
  assert.equal(pkg.version, "11.8.2.3");

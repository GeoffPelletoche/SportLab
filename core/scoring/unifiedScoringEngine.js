...
export function scoreAnalysis(analysis = {}, moduleId = "unknown") {
  ...
  return Object.freeze({ moduleId, unifiedScore, confidence, dataQuality, stability, schemaVersion: SCORING_SCHEMA_VERSION, modelVersion: MODEL_VERSIONS[moduleId] || "SPORTLAB-8.0.0" });
}

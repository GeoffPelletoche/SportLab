...
// V11.5.2 — Unified Recent Bet Context (NFL Totals)
function renderNflRecentBetContext(match) {
  const bets=getBets();
  const homeBet=findLatestNflTeamBet(bets,match?.homeId,match?.home);
